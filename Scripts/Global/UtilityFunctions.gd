...
static func align_y_3D(xform:Transform3D, new_y:Vector3): ## Rotates the given Transform3D so that it's up direction aligns with the specified up direction. Used for gravity manipulation.
...
static func align_y_2D(xform:Transform2D, new_y:Vector2): ## Rotates the given Transform2D so that it's up direction aligns with the specified up direction. Used for gravity manipulation. 
